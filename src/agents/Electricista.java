...
public class Electricista extends Agent {
    ...
    protected void setup() {
        ...
        sd.setType("electricista");
        sd.setName("contrato-electricista");
        dfd.addServices(sd);
        try {
    ...
    private class OfertarContrato extends CyclicBehaviour {
        ...
        public void action() {
            MessageTemplate mt = MessageTemplate.and(MessageTemplate.MatchPerformative(ACLMessage.CFP),
                    MessageTemplate.MatchConversationId("contrato-electricista"));
                ...
                addBehaviour(new TickerBehaviour(myAgent, 500) {
                    ...
                    protected void onTick() {
                        if (jornadaActual == jornadas) {
                            System.out.println("Trabajo electrico Finalizado");
                            doDelete();
                        } else {
                            jornadaActual++;
                        }
