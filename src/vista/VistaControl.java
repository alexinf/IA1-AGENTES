...
public class VistaControl extends javax.swing.JFrame {
    ...
    int presupuesto;
    int planoActual;
    public VistaControl(int presupuesto, int planoActual) {
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Constructora Marquez");
        this.presupuesto = presupuesto;
        this.planoActual = planoActual + 1;
        jLabel2.setText("Con el presupuesto " + presupuesto + " USD y el plano numero " + planoActual);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaControl(0, 0).setVisible(true);
            }
        });
    }
